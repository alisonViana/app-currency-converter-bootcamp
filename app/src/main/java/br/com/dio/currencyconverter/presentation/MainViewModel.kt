package br.com.dio.currencyconverter.presentation
...
class MainViewModel(
    ...
    fun getExchangeValues(coins: String) {
    ...
    sealed class State() {
        ...
        data class Success(val value: ExchangeResponseValue): State()  //val value: Any - classe genérica
